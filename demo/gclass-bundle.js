(() => {
  ...
  var _createSibling = function _createSibling2(element, i) {
    if (element.parentNode && (_doc3 || _setDoc(element))) {
      var svg = _svgOwner(element), ns = svg ? svg.getAttribute("xmlns") || "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml", type = svg ? i ? "rect" : "g" : "div", x = i !== 2 ? 0 : 100, y = i === 3 ? 100 : 0, css = {
        ...
        margin: "0",
        padding: "0"
      }, e = _doc3.createElementNS ? _doc3.createElementNS(ns.replace(/^https/, "http"), type) : _doc3.createElement(type);
      if (i) {
        if (!svg) {
          if (!_divContainer) {
  ...
  var _getComputedStyle = function _getComputedStyle2(element) {
    return _win5.getComputedStyle(element.nodeType === Node.DOCUMENT_NODE ? element.scrollingElement : element);
  };
  ...
  var ScrollTrigger2 = /* @__PURE__ */ (function() {
    ...
    _proto.init = function init5(vars, animation) {
      ...
      self.update = function(reset2, recordVelocity, forceFake) {
        ...
        var scroll = _refreshingAll === true ? prevScroll : self.scroll(), p = reset2 ? 0 : (scroll - start) / change, clipped = p < 0 ? 0 : p > 1 ? 1 : p || 0, prevProgress2 = self.progress, isActive, wasActive, toggleState, action, stateChanged, toggled, isAtMax, isTakingAction;
        if (recordVelocity) {
          scroll2 = scroll1;
    ...
    ScrollTrigger3.enable = function enable() {
      ...
      if (gsap4) {
        ...
        if (_body4) {
          ...
          var bodyHasStyle = _body4.hasAttribute("style"), bodyStyle = _body4.style, border = bodyStyle.borderTopStyle, AnimationProto = gsap4.core.Animation.prototype, bounds, i;
  ...
  var _toArray3 = (r) => !r ? [] : typeof r === "string" ? _toArray3(document.querySelectorAll(r)) : "length" in r ? Array.from(r).reduce((acc, cur) => {
    typeof cur === "string" ? acc.push(..._toArray3(cur)) : acc.push(cur);
    return acc;
  }, []) : [r];
  var _elements = (targets) => _toArray3(targets).filter((e) => e && e.nodeType === 1);
  var _emptyArray3 = [];
  ...
  var _SplitText = class _SplitText2 {
      ...
      (this._ctx || _defaultContext).add(() => {
        ...
        if (splitCharacters || splitWords || splitLines) {
          this.elements.forEach((element, index) => {
            ...
            if (splitLines) {
              let nodes = _toArray3(element.childNodes), wrapLine = _getLineWrapper(element, nodes, config3, lines), curNode, toRemove = [], lineStartIndex = 0, allBounds = nodes.map((n) => n.nodeType === 1 ? n.getBoundingClientRect() : _emptyBounds), lastBounds = _emptyBounds, curBounds;
    ...
    static register(core) {
      gsap6 = gsap6 || core || window.gsap;
      if (gsap6) {
        _toArray3 = gsap6.utils.toArray;
        _context4 = gsap6.core.context || _context4;
      }
  ...
  var easeOf = (e) => e || DEFAULT_EASE;
  var finalOpacity = (target) => {
  ...
  function SpawnV(target, delay, dir, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { opacity: 0, y: dir, scale: 0.97 }, { ease: e, duration: dur, delay, y: 0, opacity: finalOpacity(target), scale: 1 });
  }
  function SpawnH(target, delay, dir, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { opacity: 0, x: dir, scale: 0.97 }, { ease: e, duration: dur, delay, x: 0, opacity: finalOpacity(target), scale: 1 });
  }
  function expandV(target, delay, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { opacity: 1, scaleY: 0 }, { ease: e, duration: dur, delay, scaleY: 1, opacity: finalOpacity(target), transformOrigin: "50% 50%" });
  }
  function expandH(target, delay, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { opacity: 1, scaleX: 0 }, { ease: e, duration: dur, delay, scaleX: 1, opacity: finalOpacity(target), transformOrigin: "50% 50%" });
  }
  function expandA(target, delay, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { opacity: 1, scale: 0 }, { ease: e, duration: dur, delay, scale: 1, opacity: finalOpacity(target), transformOrigin: "50% 50%" });
  }
  function typewriter(target, text, dur, delay, ease) {
    return gsapWithCSS.fromTo(target, { text: "" }, { ease: easeOf(ease), duration: dur, delay, text });
  }
  function spawnSpinCCW(target, delay, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { scale: 0, rotation: -90 }, { ease: e, duration: dur, delay, scale: 1, rotation: 0, transformOrigin: "50% 50%" });
  }
  function spawnSpinCW(target, delay, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { scale: 0, rotation: 90 }, { ease: e, duration: dur, delay, scale: 1, rotation: 0, transformOrigin: "50% 50%" });
  }
  function spawnFade(target, delay, dur, ease) {
    return gsapWithCSS.fromTo(target, { opacity: 0 }, { ease: easeOf(ease), duration: dur, delay, opacity: finalOpacity(target) });
  }
  function spawnBlur(target, delay, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { opacity: 0, filter: "blur(20px)" }, { ease: e, duration: dur, delay, opacity: finalOpacity(target), filter: "blur(0px)" });
  }
  var CLIP_FROM = {
    up: "inset(0% 0% 100% 0%)",
  ...
  function spawnClipReveal(target, delay, dur, ease, dir = "up") {
    const from = CLIP_FROM[dir] || CLIP_FROM.up;
    return gsapWithCSS.fromTo(target, { clipPath: from }, { clipPath: "inset(0% 0% 0% 0%)", ease: easeOf(ease), duration: dur, delay });
  }
  function curtainHorizontal(target, delay, dur, ease) {
    return gsapWithCSS.fromTo(target, { clipPath: "inset(0% 50% 0% 50%)" }, { clipPath: "inset(0% 0% 0% 0%)", ease: easeOf(ease), duration: dur, delay });
  }
  function curtainVertical(target, delay, dur, ease) {
    return gsapWithCSS.fromTo(target, { clipPath: "inset(50% 0% 50% 0%)" }, { clipPath: "inset(0% 0% 0% 0%)", ease: easeOf(ease), duration: dur, delay });
  }
  function spawnXUp(target, delay, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { scale: 0, rotationX: 360, opacity: 0 }, { ease: e, duration: dur, delay, scale: 1, rotationX: 0, opacity: finalOpacity(target), transformOrigin: "50% 50%" });
  }
  function spawnXDown(target, delay, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { scale: 0, rotationX: -360, opacity: 0 }, { ease: e, duration: dur, delay, scale: 1, rotationX: 0, opacity: finalOpacity(target), transformOrigin: "50% 50%" });
  }
  function spawnYRight(target, delay, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { scale: 0, rotationY: 360, opacity: 0 }, { ease: e, duration: dur, delay, scale: 1, rotationY: 0, opacity: finalOpacity(target), transformOrigin: "50% 50%" });
  }
  function spawnYLeft(target, delay, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.fromTo(target, { scale: 0, rotationY: -360, opacity: 0 }, { ease: e, duration: dur, delay, scale: 1, rotationY: 0, opacity: finalOpacity(target), transformOrigin: "50% 50%" });
  }
  function expandRight(target, delay, dur, ease) {
    const e = easeOf(ease);
    const tl = gsapWithCSS.timeline();
    tl.set(target, { transformOrigin: "100% 50%" }).fromTo(target, { opacity: 1, scaleX: 0 }, { ease: e, duration: dur, delay, scaleX: 1, opacity: finalOpacity(target) });
    return tl;
  }
  function expandLeft(target, delay, dur, ease) {
    const e = easeOf(ease);
    const tl = gsapWithCSS.timeline();
    tl.set(target, { transformOrigin: "0% 50%" }).fromTo(target, { opacity: 1, scaleX: 0 }, { ease: e, duration: dur, delay, scaleX: 1, opacity: finalOpacity(target) });
    return tl;
  }
  function expandUp(target, delay, dur, ease) {
    const e = easeOf(ease);
    const tl = gsapWithCSS.timeline();
    tl.set(target, { transformOrigin: "50% 100%" }).fromTo(target, { opacity: 1, scaleY: 0 }, { ease: e, duration: dur, delay, scaleY: 1, opacity: finalOpacity(target) });
    return tl;
  }
  function expandDown(target, delay, dur, ease) {
    const e = easeOf(ease);
    const tl = gsapWithCSS.timeline();
    tl.set(target, { transformOrigin: "50% 0%" }).fromTo(target, { opacity: 1, scaleY: 0 }, { ease: e, duration: dur, delay, scaleY: 1, opacity: finalOpacity(target) });
    return tl;
  }
  function countTargetVars(target) {
  ...
  function countUp(target, delay, dur, ease) {
    const e = easeOf(ease);
    const { start, end, decimals } = countTargetVars(target);
    const obj = { n: start };
    return gsapWithCSS.timeline({ delay }).fromTo(obj, { n: start }, { n: end, duration: dur, ease: e, onUpdate: () => {
      target.textContent = obj.n.toFixed(decimals);
    } }, 0);
  }
  function verticalmove(target, amount, dur, ease) {
    const e = easeOf(ease);
    return gsapWithCSS.to(target, { y: amount, scale: 1 + amount / 1e3, duration: dur, ease: e });
  }
  function expandmove(target, amount, dur, ease) {
    return gsapWithCSS.to(target, { scale: amount / 10, duration: dur, ease: easeOf(ease) });
  }
  function magnet(target, x, y, scale, dur, ease) {
    return gsapWithCSS.to(target, { x, y, scale, duration: dur, ease: easeOf(ease), overwrite: "auto" });
  }
  function magnet3d(target, x, y, scale, rotX, rotY, dur, ease) {
    return gsapWithCSS.to(target, { x, y, scale, rotationX: rotX, rotationY: rotY, transformOrigin: "50% 50%", transformPerspective: 600, duration: dur, ease: easeOf(ease), overwrite: "auto" });
  }
  function reset(target, dur, ease) {
    gsapWithCSS.to(target, { x: 0, y: 0, scale: 1, duration: dur / 2, ease });
  }
  function spinCW(target, delay, dur, ease) {
    const e = easeOf(ease);
    const tl = gsapWithCSS.timeline();
    tl.fromTo(target, { scale: 1, rotation: 0 }, { ease: e, duration: dur, delay, rotation: 360 }).to(target, { scale: 1, duration: delay });
    return tl;
  }
  function spinCCW(target, delay, dur, ease) {
    const e = easeOf(ease);
    const tl = gsapWithCSS.timeline();
    tl.fromTo(target, { scale: 1, rotation: 0 }, { ease: e, duration: dur, delay, rotation: -360 }).to(target, { scale: 1, duration: delay });
    return tl;
  }
  function bounce(delay, target, amount, dur, ease) {
    const e = easeOf(ease);
    const tl = gsapWithCSS.timeline();
    tl.set(target, { transformOrigin: "50% 100%" }).to(target, { y: -amount - amount * 0.25, scaleX: 0.97, scaleY: 1.03, duration: dur * 0.48, ease: "power1.out" }).to(target, { y: 0, scaleX: 1.08, scaleY: 0.88, duration: dur * 0.3, ease: "power2.in" }).to(target, { y: 0, scaleX: 1, scaleY: 1, duration: dur * 0.12, ease: e }).to(target, { x: 0, duration: delay });
    return tl;
  }
  function shake(delay, target, amount, dur, ease) {
    const tl = gsapWithCSS.timeline();
    tl.to(target, { x: amount, duration: dur * 0.1, ease: "power2.out" }).to(target, { x: -amount * 0.8, duration: dur * 0.15, ease: "power2.inOut" }).to(target, { x: amount * 0.5, duration: dur * 0.2, ease: "power2.inOut" }).to(target, { x: -amount * 0.25, duration: dur * 0.2, ease: "power2.inOut" }).to(target, { x: 0, duration: dur * 0.2, ease: easeOf(ease) }).to(target, { x: 0, duration: delay });
    return tl;
  }
  function bell(delay, target, amount, dur, ease) {
    const tl = gsapWithCSS.timeline();
    tl.set(target, { transformOrigin: "50% 0%" }).to(target, { rotate: amount, duration: dur * 0.12, ease: "power2.out" }).to(target, { rotate: -amount * 0.7, duration: dur * 0.18, ease: "power2.inOut" }).to(target, { rotate: amount * 0.4, duration: dur * 0.22, ease: "power2.inOut" }).to(target, { rotate: -amount * 0.15, duration: dur * 0.22, ease: "power2.inOut" }).to(target, { rotate: 0, duration: dur * 0.2, ease: easeOf(ease) }).to(target, { rotate: 0, duration: delay });
    return tl;
  }
  function pulse(delay, target, amount, dur, ease) {
    const e = easeOf(ease);
    const tl = gsapWithCSS.timeline();
    tl.to(target, { scale: amount / 10 * 1.05, duration: dur * 0.35, ease: "power2.out" }).to(target, { scale: 1, duration: dur * 0.45, ease: e }).to(target, { scale: 1, duration: delay });
    return tl;
  }
  function radiate(delay, target, amount, dur, ease, zIndex) {
    ...
    return gsapWithCSS.fromTo(clone, { scale: 1, opacity: 1 }, {
      scale: amount / 10,
      opacity: 0,
      duration: dur,
      delay,
  ...
  function hover(delay, target, amount, dur, ease) {
    const tl = gsapWithCSS.timeline();
    tl.set(target, { transformOrigin: "50% 50%" }).to(target, { y: -amount, scaleX: 0.98, scaleY: 1.02, duration: dur / 2, ease: "sine.inOut" }).to(target, { y: 0, scaleX: 1, scaleY: 1, duration: dur / 2, ease: "sine.inOut" });
    return tl;
  }
  function marquee(target, dir, duration, xOffset = 0, yOffset = 0, noRepeat = false) {
    ...
    if (!first) return gsapWithCSS.fromTo(track, {}, { duration: 0 });
    ...
    const dist = unitSize;
    const vars = { duration, ease: "none" };
    if (dir === "right") return gsapWithCSS.fromTo(track, { x: -dist }, { x: 0, ...vars });
    if (dir === "up") return gsapWithCSS.fromTo(track, { y: 0 }, { y: -dist, ...vars });
  ...
  var customAnims = [
    ...
    // --------------------------------------------------------------------------
    {
      ...
      play: (el, delay, dur, ease) => gsapWithCSS.fromTo(
        el,
    ...
    // --------------------------------------------------------------------------
    {
      ...
      play: (el, delay, dur, ease) => {
        ...
        tl.fromTo(el, { scale: 0, opacity: 0 }, { scale: 1.1, opacity: 1 }).to(el, { scale: 0.95 }).to(el, { scale: 1 });
        return tl;
      }
    }
  ];
  ...
  var animations = [
    ...
    { sel: ".spawn-down", from: { opacity: 0, y: -defaults2.spawnOffset }, play: (el, delay, dur, ease) => SpawnV(el, delay, -defaults2.spawnOffset, dur, ease) },
    { sel: ".spawn-up", from: { opacity: 0, y: defaults2.spawnOffset }, play: (el, delay, dur, ease) => SpawnV(el, delay, defaults2.spawnOffset, dur, ease) },
    { sel: ".spawn-left", from: { opacity: 0, x: -defaults2.spawnOffset }, play: (el, delay, dur, ease) => SpawnH(el, delay, -defaults2.spawnOffset, dur, ease) },
    { sel: ".spawn-right", from: { opacity: 0, x: defaults2.spawnOffset }, play: (el, delay, dur, ease) => SpawnH(el, delay, defaults2.spawnOffset, dur, ease) },
  ...
  function normalize3(extra = []) {
    const all = animations.concat(extra);
    const spawnConfigs2 = all.filter((a) => a.play).map((a) => ({
      sel: a.sel,
      from: a.from,
      play: a.play,
    ...
    const loopConfigs2 = all.filter((a) => a.build).map((a) => ({
      sel: a.sel,
      build: a.build,
      key: a.key || a.sel.slice(1),
      loop: a.loop !== false
    }));
    return { all, spawnConfigs: spawnConfigs2, loopConfigs: loopConfigs2 };
  }

  // Listeners.js
  var TEXT_PREFIX = "spawn-text-";
  var TEXT_PREFIX_LEN = TEXT_PREFIX.length;
  var { all: animAll, spawnConfigs, loopConfigs } = normalize3(customAnims);
  ...
  function initListeners() {
    gsapWithCSS.registerPlugin(TextPlugin, ScrollTrigger2, SplitText);
    ...
    const flipStates = /* @__PURE__ */ new WeakMap();
    const flipping = /* @__PURE__ */ new WeakSet();
    const flipPos = (node) => {
    ...
    const playFlip = (node) => {
      if (node._flipTween) {
        ...
        gsapWithCSS.set(node, { clearProps: "transform" });
      ...
      if (!dx && !dy) return;
      flipping.add(node);
      node._flipTween = gsapWithCSS.fromTo(
        node,
        { x: dx, y: dy },
        {
          x: 0,
          y: 0,
          duration: readClassNumber(node, "time-", defaults2.effectDuration),
          ease: getEase(node),
          onComplete: () => {
            flipping.delete(node);
            node._flipTween = null;
    ...
    const playLeave = (node) => {
      const snap3 = leaveStates.get(node);
      leaveStates.delete(node);
      if (!snap3 || node._leaving) return;
      node._leaving = true;
      const placeSpacer = (snap4) => {
        if (!snap4.parent || snap4.parent.nodeType !== 1) return null;
        const spacer2 = document.createElement("div");
        spacer2.style.cssText = `box-sizing:border-box;width:${snap4.rect.width}px;height:${snap4.rect.height}px;`;
        if (snap4.margin) spacer2.style.margin = snap4.margin;
        const next = snap4.next && snap4.next.parentNode === snap4.parent ? snap4.next : null;
        snap4.parent.insertBefore(spacer2, next);
        return spacer2;
      };
      if (snap3.tween) {
        const reattached = !node.isConnected;
        const spacer2 = reattached ? placeSpacer(snap3) : null;
        if (reattached) {
          node.classList.remove("leave", "appear", "scroll", "scroll-progress");
          node.style.cssText = `position:fixed;z-index:${snap3.zIndex};left:${snap3.rect.left}px;top:${snap3.rect.top}px;
                        width:${snap3.rect.width}px;height:${snap3.rect.height}px;margin:0;`;
      ...
      ghost.innerHTML = snap3.html;
      const g = ghost.firstElementChild;
      g.classList.remove("leave", "appear", "scroll", "scroll-progress");
      g.style.cssText = `position:fixed;z-index:${snap3.zIndex};left:${snap3.rect.left}px;top:${snap3.rect.top}px;
                width:${snap3.rect.width}px;height:${snap3.rect.height}px;margin:0;`;
      document.body.appendChild(g);
      const spacer = placeSpacer(snap3);
      gsapWithCSS.to(g, {
        ...snap3.from,
        duration: defaults2.effectDuration,
    ...
    const orderSelector = () => spawnConfigs.map(({ sel }) => sel).join(",") + "," + spawnConfigs.map(({ sel }) => "." + TEXT_PREFIX + sel.slice(1)).join(",");
    const getOrderDelay = (el, priority) => {
      const samepri = gsapWithCSS.utils.toArray(orderSelector()).filter((e) => {
      ...
      return order / defaults2.orderDivide;
    };
    const readTiming = (el) => {
      const priority = readClassNumber(el, "priority-", 0);
      return {
        delay: el.classList.contains("order") ? getOrderDelay(el, priority) : priority * defaults2.spawnDelayMultiplier,
    ...
    const playNamed = (el, name) => {
      ...
      const tween = entry.play ? entry.play(el, delay, dur, getEase(el)) : entry.build(el, readLoopCtx(el));
      if (!tween) return;
    ...
    const textSplits = [];
    const splitCache = /* @__PURE__ */ new WeakMap();
    const RTL_RE = /[\u0590-\u08FF\uFB50-\uFDFF\uFE70-\uFEFF]/;
    ...
    const playText = (el, from, delay, dur, ease) => {
      ...
      if (requestedStagger != null) {
        ...
        duration = Math.max(dur - stagger * (parts.length - 1), defaults2.minTextPartDuration);
      } else {
        duration = Math.min(dur, Math.max(dur / 3, defaults2.minTextPartDuration));
        stagger = parts.length > 1 ? (dur - duration) / (parts.length - 1) : 0;
      }
      return gsapWithCSS.fromTo(parts, { ...from }, {
        ...computeTo(from),
        ease,
        duration,
        delay,
    ...
    const playTypewriterSplit = (el, delay, dur, ease) => {
      ...
      return gsapWithCSS.fromTo(parts, { opacity: 0 }, {
        opacity: 1,
        ease,
        duration: Math.min(defaults2.typewriterSplitCharDuration, perChar),
        delay,
        stagger: perChar,
    ...
    const setupPin = (el) => {
      ...
      const clamp3 = (n) => Math.min(100, Math.max(0, n));
      const startClass = readClassNumber(el, "progress-start-", null);
      const endClass = readClassNumber(el, "progress-end-", null);
      const start = startClass != null ? `top ${clamp3(100 - startClass)}%` : "top top";
      const end = endClass != null ? `top ${clamp3(100 - endClass)}%` : "bottom top";
      const t = ScrollTrigger2.create({
        trigger: el,
        start,
        end,
        pin: true,
      ...
      if (el.classList.contains("progress-bar") || el.classList.contains("scroll-fill")) {
        ...
        const t = gsapWithCSS.fromTo(
          ...
          { scaleX: reverse ? 1 : 0 },
          {
            ...
            scrollTrigger: {
              trigger: el,
              start: startClass != null ? `top ${clamp3(100 - startClass)}%` : "top bottom",
              end: endClass != null ? `top ${clamp3(100 - endClass)}%` : "bottom top",
              scrub: true
            }
          }
        );
    ...
    const setupScroll = (el) => {
      ...
      if (el.classList.contains("scroll-progress")) {
        ...
        const tl = gsapWithCSS.timeline({
          scrollTrigger: {
            trigger: el,
            start: startClass != null ? `top ${clamp3(100 - startClass)}%` : defaults2.progressStart,
            end: endClass != null ? `top ${clamp3(100 - endClass)}%` : defaults2.progressEnd,
            scrub: true
          }
        });
        if (config3.count) {
          ...
          tl.fromTo(obj, { n: reverse ? end : start }, { n: reverse ? start : end, ease: ease2, onUpdate: () => {
            el.textContent = obj.n.toFixed(decimals);
          } }, 0);
        } else if (typewriterSplit) {
          const parts = getParts(el, getGranularity(el));
          if (parts.length) tl.fromTo(parts, { opacity: reverse ? 1 : 0 }, { opacity: reverse ? 0 : 1, ease: ease2 });
        } else {
          tl.fromTo(el, { ...reverse ? to : from }, { ...reverse ? from : to, ease: ease2 });
        }
      ...
      const enter = () => {
        ...
        el._scrollTween = isTypewriter ? typewriterSplit ? playTypewriterSplit(el, delay, duration, ease) : typewriter(el, fullText, duration, delay, ease) : play(el, delay, duration, ease);
      ...
      const reverseToStart = () => {
        ...
        if (typewriterSplit) {
          const parts = getParts(el, getGranularity(el));
          if (parts.length) gsapWithCSS.to(parts, { opacity: 0, ease, duration: 0.3 });
          return;
        }
        el._scrollTween = gsapWithCSS.to(el, { ...from, ease, duration: 0.3 });
      };
    ...
    gsapWithCSS.utils.toArray(".scroll, .scroll-progress").forEach(setupScroll);
    spawnConfigs.forEach(({ sel, from, typewriter: isTypewriter, text }) => {
      ...
      gsapWithCSS.utils.toArray(tSel + ".scroll:not(.scroll-progress)").forEach((el) => {
        if (isReduced(el)) return;
        const { delay, duration } = readTiming(el);
        ...
        scrollTriggers.push(ScrollTrigger2.create({
          trigger: el,
          start: "top bottom",
          end: "top top",
          onEnter: enter,
      ...
      gsapWithCSS.utils.toArray(tSel + ".scroll-progress").forEach((el) => {
        if (isReduced(el)) return;
        const ease = getEase(el);
        const parts = getParts(el, getGranularity(el));
        if (!parts.length) return;
    ...
    spawnConfigs.forEach(({ sel, from, typewriter: isTypewriter, text }) => {
      if (isTypewriter || text === false) return;
      const tSel = "." + TEXT_PREFIX + sel.slice(1);
      gsapWithCSS.utils.toArray(tSel).forEach((el) => {
        if (el.classList.contains("scroll") || el.classList.contains("scroll-progress")) return;
        if (isPreserved(el)) return;
        if (isReduced(el)) return;
        const { delay, duration } = readTiming(el);
    ...
    const setupMagnet = (el) => {
      ...
      const onMove = threeD ? magnet3dOnMove(el, pull, grow, tilt, duration, elEase) : magnetOnMove(el, pull, grow, duration, elEase);
      const onLeave = threeD ? magnet3dOnLeave(el, duration, elEase) : magnetOnLeave(el, duration, elEase);
    ...
    const setupClicks = (el) => {
      ...
      if (el.classList.contains("click-hover")) {
        ...
        let touch = false;
        const duration = readClassNumber(el, "ctime-", defaults2.clickDuration);
        const lift = readClassNumber(el, "amount-", defaults2.clickOffset);
        const elEase = getEase(el);
        addListener(area, "mousedown", () => {
          if (!touch) {
            pauseCompatLoops(el);
            verticalmove(el, -lift / 2, duration, elEase);
          }
        });
        addListener(area, "mouseover", () => {
          if (!touch) {
            pauseCompatLoops(el);
            verticalmove(el, -lift, duration, elEase);
          }
        });
        addListener(area, "mouseleave", () => {
          if (!touch) {
            verticalmove(el, 0, duration, elEase);
            resumeCompatLoops(el);
          }
        });
        addListener(area, "mouseup", () => {
          if (!touch) verticalmove(el, -lift, duration, elEase);
        });
        addListener(area, "touchstart", () => {
          touch = true, pauseCompatLoops(el), verticalmove(el, lift / 2, duration, elEase);
        });
        addListener(area, "touchend", () => {
          touch = true, verticalmove(el, 0, duration, elEase), setTimeout(() => {
            touch = false;
          }, 0);
        });
      }
      if (el.classList.contains("click-expand")) {
        let touch = false;
        const duration = readClassNumber(el, "ctime-", defaults2.clickDuration);
        const lift = readClassNumber(el, "amount-", defaults2.clickExpandOffset);
        const elEase = getEase(el);
        addListener(el, "mousedown", () => {
          if (!touch) {
            pauseCompatLoops(el);
            expandmove(el, 10, duration, elEase).eventCallback("onComplete", () => fireOnComplete(el, "click"));
          }
        });
        addListener(el, "mouseover", () => {
          if (!touch) {
            pauseCompatLoops(el);
            expandmove(el, lift, duration, elEase);
          }
        });
        addListener(el, "mouseleave", () => {
          if (!touch) {
            expandmove(el, 10, duration, elEase);
            resumeCompatLoops(el);
          }
        });
        addListener(el, "mouseup", () => {
          if (!touch) expandmove(el, lift, duration, elEase);
        });
        addListener(el, "touchstart", () => {
          touch = true, pauseCompatLoops(el), expandmove(el, lift, duration, elEase);
        });
        addListener(el, "touchend", () => {
          touch = true, expandmove(el, 10, duration, elEase).eventCallback("onComplete", () => fireOnComplete(el, "click")), setTimeout(() => {
            touch = false;
          }, 0);
        });
      }
    ...
    const readLoopCtx = (el) => ({
      edelay: readClassNumber(el, "edelay-", defaults2.effectDelay),
      amount: readClassNumber(el, "amount-", defaults2.effectOffset),
      etime: readClassNumber(el, "etime-", defaults2.effectDuration),
      ease: getEase(el),
      ...
      loopConfigs.forEach(({ sel, build, key, loop }) => {
        ...
        if (el.matches(sel)) {
          ...
          el[key].eventCallback(
            el[key].repeat() === -1 ? "onRepeat" : "onComplete",
    ...
    const deferLoopBuild = (el, tween) => {
      if (!tween.__gsapPendingLoops) tween.__gsapPendingLoops = /* @__PURE__ */ new Set();
      ...
      tween.eventCallback("onComplete", function() {
        ...
        tween.__gsapPendingLoops = /* @__PURE__ */ new Set();
    ...
    applyMagnet();
    let flipRoots = /* @__PURE__ */ new Set();
    ...
    const animateAppear = (el) => {
      ...
      const config3 = findSpawn(el);
      if (isTextElement(el)) {
        el._spawnTween = playText(el, config3.from, delay, duration, ease);
        return;
      }
      if (!config3) return el._spawnTween = SpawnV(el, delay, -defaults2.spawnOffset, duration, ease);
      if (config3.typewriter) {
        const easeClass = [...el.classList].find((c) => c.startsWith("ease-"));
        const elEase = easeClass ? easeClass.split("-")[1] : "none";
        el._spawnTween = config3.typewriterSplit ? playTypewriterSplit(el, delay, duration, elEase) : config3.play(el, delay, duration, elEase);
      } else {
        el._spawnTween = config3.play(el, delay, duration, ease);
        el._spawnTween.eventCallback("onComplete", () => {
          if (el.classList.contains("leave")) refreshLeaveRect(el);
          if (el.classList.contains("flip")) captureFlip(el);
          fireOnComplete(el, "spawn");
    ...
    const appearObserver = new MutationObserver((mutations) => {
      mutations.forEach((mutation) => {
        mutation.addedNodes.forEach((node) => {
          ...
          applyMagnet();
          if (pinned) ScrollTrigger2.refresh();
        });
      });
    });
    appearObserver.observe(document.body, { childList: true, subtree: true });
    gsapWithCSS.utils.toArray(".leave").forEach(captureLeave);
    ...
    const refreshLeavePositions = () => {
      ...
      positionTick = true;
      requestAnimationFrame(() => {
        gsapWithCSS.utils.toArray(".leave").forEach((el) => {
          const s = leaveStates.get(el);
  ...
  // AnimToggle.js
  var STORAGE_KEY = "funbyte-animations-enabled";
