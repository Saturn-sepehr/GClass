...
```
npm install gsap-animation-system
```
...
```html
<script type="module">
  import { initAnimations } from 'gsap-animation-system'
  initAnimations()
</script>
```
...
```js
import { initAnimations, toggleAnimations } from 'gsap-animation-system'
...
```js
import { customAnims } from 'gsap-animation-system'
